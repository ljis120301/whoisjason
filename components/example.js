const AboutSection = () => {
    return (
      <section className="bg-frappe-overlay2 dark:bg-frappe-crust p-20 rounded-2xl shadow-lg mt-10 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[#c6d0f5] dark:text-[#f2d5cf]">
            welcome to my buzzing blog! 🍯
          </p>
        </div>
      </section>
    );
